...
import com.suhaas.capstonestage2.settings.SettingsActivity;
import com.suhaas.capstonestage2.stories.StoryActivity;
import com.suhaas.capstonestage2.views.transitions.TransitionHelper;
...
//                        articleIntent.putExtra(StoryActivity.ARG_STORY, story);
    ...
    public void toNews() {
        Intent newsIntent = new Intent(activity, MainActivity.class);
