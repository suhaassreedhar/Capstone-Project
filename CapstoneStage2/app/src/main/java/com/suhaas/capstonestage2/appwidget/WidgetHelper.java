...
import com.suhaas.capstonestage2.stories.TopStoriesFragment;
...
public class WidgetHelper {
    ...
    static class WidgetConfig {
        ...
        final Class<TopStoriesFragment> destination;
        final String title;
...
//            } else
        {
            ...
            String title;
            Class<TopStoriesFragment> destination;
//            if (!TextUtils.isEmpty(query)) {
//                title = query;
//                section = query;
//                destination = TopStoriesFragment.class;
...
//                 legacy "new stories" widget
        ...
        private WidgetConfig(Class<TopStoriesFragment> destination, String title, String section,
            ...
            this.customQuery = destination == TopStoriesFragment.class;
        }
    }
}
